...
class LocalizeReceipts {
    static func createLocalizeReceipts(_ languageIndex: LanguageIndex, paperSizeIndex: PaperSizeIndex, orderNum: Int) -> ILocalizeReceipts {
        var localizeReceipts: ILocalizeReceipts
        
        switch languageIndex {
        case LanguageIndex.english :
            localizeReceipts = EnglishReceiptsImpl(orderNum: orderNum)
